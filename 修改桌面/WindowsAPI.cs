...
namespace WindowsUser32API
{
    /// <summary>
    /// User32.dll 函数类
    /// </summary>
   public class User32_Win32Api
    {
    ...
    /*    public static extern bool PeekMessage(ref MSG msg, int hWnd, uint wFilterMin, uint wFilterMax, uint wFlag);
     ...
     /*   public static extern IntPtr BeginPaint(IntPtr hWnd, ref PAINTSTRUCT ps);
      ...
      //  static public extern int ScrollWindowEx(IntPtr hWnd, int dx, int dy, ref RECT rcScroll, ref RECT rcClip,
           // IntPtr UpdateRegion, ref RECT rcInvalidated, uint flags);
